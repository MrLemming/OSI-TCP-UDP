...
В данной программе с использованием ServerSocket реализован сервер, который имитирует 'Игру в города'.

Вот её правила. Игроки по очереди называют города, главное правило - следующий город должен начинаться на ту же букву, на которую заканчивался последний названный город.
